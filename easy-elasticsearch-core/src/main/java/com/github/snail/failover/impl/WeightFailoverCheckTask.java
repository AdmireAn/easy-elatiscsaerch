...
import com.github.snail.failover.util.SharedCheckExecutorHolder;
import com.github.snail.util.MoreSuppliers.CloseableSupplier;
...
class WeightFailoverCheckTask<T> {
    ...
    WeightFailoverCheckTask(
            WeightFailover<T> failover, WeightFailoverBuilder<T> builder, AtomicBoolean closed,
